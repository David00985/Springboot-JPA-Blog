...
// 인터넷 브라우져 요청은 무조건 get만 가능하다. 
// 그래서 테스트 목적으로 postman을 이용한다. 
...
public class HttpControllerTest {
	...
	@GetMapping("/http/get")
	public String getTest(Member m) { // id=1&username=123&password=1234&email=ssar@nate.com 도 처리해주는 스프링 MessageConverter (스프링부트) 가 해준다. 
	...
	public String postTest(@RequestBody Member m) { // MessageConverter (스프링부트) 가 해준다. 
